...
begin
    ...
    p_ut = (
            ...
            β1=0.1, β21=5.0, β22=8.0, β3=2.0, β41=8.0, β42=8.0,
            ν0=0.5, ν1=5.0, ν2=25.0, ν3=5.0, ωN=0.01, ωD=0.01,
            pα=0.0, pβ=0.0, pγ=0.0, canc=332, h_max=h_max,
            cache...
    )
...
cb1 = FunctionCallingCallback(plot_heatmap, funcat = LinRange(0, T_end, 100))
...
gif(anim, "cancer_spr_papbpg-08_enhBT.gif", fps=90)
clean_up_GPU()