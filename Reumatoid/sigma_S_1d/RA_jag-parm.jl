...
#ODEs
        ...
        @. du[:, :, 6] = β6 * (I^1 / (β7 + I^1)) - (μ7 + γ3*σv) * Jc #JAGGED in cytosol
...
for q in 1:10
    ...
    for param in 1:11
        begin
            p = (
                α1=1.0, α2=α2[param], μ1=1.0, μ2=1.0, μ3=0.01, μ4=1.0, μ5=0.5, μ6=1.0, μ7=0.5,
        ...
        y[1, param, q] = maximum(sol[end][15, 3:end-1 ,4] .- sol[end][15, 4:end ,4])
    end
    for param in 1:11
        begin
            p = (
                α1=1.0, α2=1.0, μ1=1.0, μ2=1.0, μ3=0.01, μ4=1.0, μ5=0.5, μ6=1.0, μ7=0.5,
                β1=1.1, β2=20.0, β3=100.0, β4=1.0, β6=β6[param], β7=1.1,
                γ1=2.0, γ2=1.0,γ3=1.0,
                σs=σs, σv=1.0, cache...
                )
            prob = ODEProblem(notch_func!, u0, tspan, p)
        ...
        @time sol = solve(prob, Heun(), progress = true, progress_steps = 1.0, saveat=[T_end], callback=TerminateSteadyState(5e-3));
        #calculation methods: BS3, Tsit5, Heun, ROCK2
        y[2, param, q] = maximum(sol[end][15, 3:end-1 ,4] .- sol[end][15, 4:end ,4])
    end
    for param in 1:11
        begin
            p = (
        ...
        @time sol = solve(prob, Heun(), progress = true, progress_steps = 1.0, saveat=[T_end], callback=TerminateSteadyState(5e-3));
        #calculation methods: BS3, Tsit5, Heun, ROCK2
        y[3, param, q] = maximum(sol[end][15, 3:end-1 ,4] .- sol[end][15, 4:end ,4])
    end
end
