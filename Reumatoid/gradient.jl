...
#=======================RA=======================#
Lx = 60 #number of cells in each row
Ly = 30 #number of cells in each column
...
cb1 = FunctionCallingCallback(plot_heatmap, funcat = LinRange(0, T_end, 100)) #create image at regular intervals
...
#heatmap(Array(sol[:, :, 1]), title="Notch in cell membrane", c=:inferno, clim=(0, maximum(sol[:, :, 1])))

gif(anim, "gradient_b-30.gif", fps=120) #create gif animation
