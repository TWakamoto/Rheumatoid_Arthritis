...
T = 500.0 #最終時
model = Model(n_grid=10, e = 0.01, device=device)
...
sol_anim = sol[:, 0, 1:-1, 1:-1].to('cpu').detach().numpy().copy()
plot_animation(t_anim, sol_anim, "test_beta_2d_nm1_bt.gif")
...
plot_graph(t_anim, sol_[:, 1, :, 1:-1], "test_beta_nm2_bt.gif")
'''
# %%
