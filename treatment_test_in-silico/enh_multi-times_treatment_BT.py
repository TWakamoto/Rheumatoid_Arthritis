...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 14 13:46:24 2023
...
ax2.set_xticks([])
ax2.set_yticks([])
ax2.set_title('Therapy4+Therapy5')
ims2 = []
...
ax3.set_xticks([])
ax3.set_yticks([])
ax3.set_title('Therapy4+Therapy5+Therapy6')
ims3 = []
...
# %%
anim1.save('enh_sametime_Tp4_bt.gif', writer="pillow")
anim2.save('enh_sametime_Tp4-Tp5_bt.gif', writer="pillow")
anim3.save('enh_sametime_Tp4-Tp5-Tp6_bt.gif', writer="pillow")

# %%
canc = canc/canc[0]
fig4 = plt.figure(figsize=(10,5))
ax4 = fig4.add_subplot(111)
label=["untreated", "Tp4", "Tp4+Tp5", "Tp4+Tp5+Tp6"]
#ax4.set_ylim([0.8, 1.3])
ax4.plot(label, canc, marker='o', markersize=10)
fig4.savefig("enh_sametime_456_BT.png")
plt.show()
