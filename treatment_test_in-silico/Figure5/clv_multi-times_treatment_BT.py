...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 13:31:54 2023
...
# %%
anim1.save('clv_change_Tp3_bt.gif', writer="pillow")
anim2.save('clv_change_Tp3-Tp2_bt.gif', writer="pillow")
anim3.save('clv_change_Tp3-Tp2-Tp1_bt.gif', writer="pillow")
...
fig4.savefig("clv_change_321_BT.png")
plt.show()
