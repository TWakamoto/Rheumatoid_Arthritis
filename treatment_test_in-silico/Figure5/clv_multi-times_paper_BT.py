...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 15:59:35 2023
...
h = H1[1:-1, 1:-1]-H_0
hmax = np.max(h)
canc[1, 4:6] = np.count_nonzero(h/hmax > 0.75)
...
h = H1[1:-1, 1:-1]-H_0
hmax = np.max(h)
canc[2, 5] = np.count_nonzero(h/hmax > 0.75)
...
h = H1[1:-1, 1:-1]-H_0
hmax = np.max(h)
canc[3, 5] = np.count_nonzero(h/hmax > 0.75)
...
ax4.plot(label, canc[:, 0], marker='o', markersize=10, label="Tp1-Tp2-Tp3")
ax4.plot(label, canc[:, 1], marker='o', markersize=10, label="Tp1-Tp3-Tp2")
ax4.plot(label, canc[:, 2], marker='o', markersize=10, label="Tp2-Tp1-Tp3")
ax4.plot(label, canc[:, 3], marker='o', markersize=10, label="Tp2-Tp3-Tp1")
ax4.plot(label, canc[:, 4], marker='o', markersize=10, label="Tp3-Tp1-Tp2")
ax4.plot(label, canc[:, 5], marker='o', markersize=10, label="Tp3-Tp2-Tp1")
ax4.legend(loc="best", fontsize=10)
fig4.savefig("clv_change_BT.png")
plt.show()
