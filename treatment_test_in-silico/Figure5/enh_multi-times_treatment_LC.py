...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 14 10:40:03 2023
...
# %%
anim1.save('enh_sametime_Tp4_lc.gif', writer="pillow")
anim2.save('enh_sametime_Tp4-Tp5_lc.gif', writer="pillow")
anim3.save('enh_sametime_Tp4-Tp5-Tp6_lc.gif', writer="pillow")
...
fig4.savefig("enh_sametime_456_LC.png")
plt.show()
