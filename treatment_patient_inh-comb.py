...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 13:13:28 2023
...
p_23 = np.random.rand(m, ver, wid)
p_23[0, :, :] = np.zeros((ver, wid))
p_b = np.random.rand(m, ver, wid)
p_b[0, :, :] = np.zeros((ver, wid))
#p_1 = 0.0
#p_23 = 0.0
#p_b = 0.0
#function
...
ax1.bar(label, lccell75[1:], width=0.4, align='edge', label=">0.75")
ax1.axhline(y=1.0, linestyle='dashed', color='black')
ax1.legend(loc="best", fontsize=10)
fig1.savefig("patient_inh_p1pbp23LC.png")

fig2 = plt.figure(figsize=(10,5))
ax2 = fig2.add_subplot(111)
ax2.bar(label, btcell5[1:], width=-0.4, align='edge',label=">0.5")
ax2.bar(label, btcell75[1:], width=0.4, align='edge',label=">0.75")
ax2.axhline(y=1.0, linestyle='dashed', color='black')
ax2.legend(loc="best", fontsize=10)
fig2.savefig("patient_inh_p1pbp23BT.png")
