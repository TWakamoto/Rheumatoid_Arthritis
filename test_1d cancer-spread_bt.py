...
plot_animation(t_anim, sol_H1anim[:, 1:-1, 1:-1], "test_h_bt.gif")

# %%=======================================================================================================
# get color map of protein (or gene) A (animation)
sol_anim = sol[:, 9, 1:-1, 1:-1].to('cpu').detach().numpy().copy()
plot_animation(t_anim, sol_anim, "test_i2_bt.gif")
...
plot_graph(t_anim, sol_[:, 10, :, 1:-1], "test_graph_h_bt.gif")
