...
begin
    ...
    @time lc_sol = solve(prob_lc, BS5(), progress=true, progress_steps=1.0, callback=TerminateSteadyState(1e-3), saveat=[T_end2]);
    hes   = lc_sol[end].H[2:end-1, 2:end-1] .- u0.H[2:end-1, 2:end-1]
end
...
begin
    ...
    prob_lc = ODEProblem(lung_func!, u1, tspan2, p)
    @time lc_sol = solve(prob_lc, BS5(), progress=true, progress_steps=1.0, callback=TerminateSteadyState(1e-3), saveat=[T_end3]);
    # BS3, Tsit5, Heun, 
    hes   = lc_sol[end].H[2:end-1, 2:end-1] .- u0.H[2:end-1, 2:end-1]
end
...
begin
    ...
    @time lc_sol = solve(prob_lc, BS5(), progress=true, progress_steps=1.0, callback=TerminateSteadyState(1e-3), saveat=[T_end4]);
    # BS3, Tsit5, Heun, 
    hes   = lc_sol[end].H[2:end-1, 2:end-1] .- u0.H[2:end-1, 2:end-1]
end
...
begin
    ...
    @time lc_sol = solve(prob_lc, BS5(), progress=true, progress_steps=1.0, callback=TerminateSteadyState(1e-3), saveat=[T_end5]);
    # BS3, Tsit5, Heun, 
    hes   = lc_sol[end].H[2:end-1, 2:end-1] .- u0.H[2:end-1, 2:end-1]
end
...
fig1.savefig("enh_change_LC.png")
fig1